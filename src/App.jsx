      ...
      <div className="app-container" style={{ visibility: isOpened ? 'visible' : 'hidden', opacity: isOpened ? 1 : 0, transition: 'opacity 1s ease 1s' }}>
        ...
        <footer className="footer">
          ...
          <p style={{ marginTop: '0.8rem', fontSize: '0.85rem' }}>
            Desarrollado con ♥ por <a href="https://fusionia.com.ar" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 'bold' }}>Fusión IA</a> & <a href="https://www.instagram.com/fuegocreativosde/" target="_blank" rel="noopener noreferrer" style={{ color: 'var(--color-primary)', textDecoration: 'none', fontWeight: 'bold' }}>Fuego Creativo</a>
          </p>
        </footer>
